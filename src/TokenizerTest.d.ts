...
interface TokenizerTestInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "AssetBondSettled(address,address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,string)": EventFragment;
...
export class TokenizerTest extends Contract {
  ...
  interface: TokenizerTestInterface;
