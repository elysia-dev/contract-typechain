...
interface MoneyPoolTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "utilzedReserveForTest(address,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "utilzedReserveForTest",
...
export class MoneyPoolTest extends Contract {
  ...
  interface: MoneyPoolTestInterface;
  ...
  functions: {
    ...
    "utilzedReserveForTest(address,uint256,uint256)"(
      asset: string,
      totalSupply: BigNumberish,
      totalBorrow: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
