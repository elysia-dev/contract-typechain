...
import type { IndexTest } from "../IndexTest";

export class IndexTest__factory extends ContractFactory {
  constructor(
    linkLibraryAddresses: IndexTestLibraryAddresses,
    signer?: Signer
  ) {
    super(_abi, IndexTest__factory.linkBytecode(linkLibraryAddresses), signer);
  }
  ...
  static linkBytecode(linkLibraryAddresses: IndexTestLibraryAddresses): string {
    ...
    linkedBytecode = linkedBytecode.replace(
      ...
      linkLibraryAddresses["__$b2803e6fc9c1907245baf73f249fd756da$__"]
        .replace(/^0x/, "")
        .toLowerCase()
    );
...
export interface IndexTestLibraryAddresses {
  ["__$b2803e6fc9c1907245baf73f249fd756da$__"]: string;
}
